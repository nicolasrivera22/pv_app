...
CYTOSCAPE_STYLESHEET = [
    ...
    {"selector": ".role-pv", "style": {"shape": "round-rectangle", "background-color": "#fffbeb", "border-color": "#f59e0b", "text-margin-y": "-20px"}},
    {"selector": ".role-inverter", "style": {"shape": "round-rectangle", "background-color": "#eff6ff", "border-color": "#2563eb", "text-margin-y": "-20px"}},
    {"selector": ".role-battery", "style": {"shape": "round-rectangle", "background-color": "#f5f3ff", "border-color": "#7c3aed", "text-margin-y": "-20px"}},
