...
TABLE_COLUMN_SCHEMAS: dict[str, dict[str, TableColumnUiSchema]] = {
    ...
    "demand_profile": {
        "Dia": TableColumnUiSchema("Dia", "Day", "Nombre opcional del dia asociado a la fila.", "Optional day name for the row."),
        "DOW": TableColumnUiSchema("DOW", "DOW", "Dia de la semana en la tabla 7x24.", "Day of week in the 7x24 table.", "integer", 0, "numeric"),
        "HOUR": TableColumnUiSchema("HOUR", "HOUR", "Hora del dia.", "Hour of the day.", "integer", 0, "numeric"),
        "RES": TableColumnUiSchema("RES", "RES", "Demanda residencial de esa hora.", "Residential demand for that hour.", "kwh", 2, "numeric"),
        "IND": TableColumnUiSchema("IND", "IND", "Demanda industrial de esa hora.", "Industrial demand for that hour.", "kwh", 2, "numeric"),
        "TOTAL_kWh": TableColumnUiSchema("TOTAL_kWh", "TOTAL_kWh", "Demanda total derivada de la hora.", "Total hourly demand derived from RES + IND.", "kwh", 2, "numeric"),
    },
    ...
    "demand_profile_weights": {
        "HOUR": TableColumnUiSchema("HOUR", "HOUR", "Hora del dia.", "Hour of the day.", "integer", 0, "numeric"),
        "W_RES": TableColumnUiSchema("W_RES", "W_RES", "Peso relativo residencial editable.", "Editable residential weight.", "percent", 3, "numeric"),
        "W_IND": TableColumnUiSchema("W_IND", "W_IND", "Peso relativo industrial editable.", "Editable industrial weight.", "percent", 3, "numeric"),
        "W_RES_BASE": TableColumnUiSchema("W_RES_BASE", "W_RES_BASE", "Base residencial usada para normalizar.", "Residential base used for normalization.", "percent", 3, "numeric"),
        "W_IND_BASE": TableColumnUiSchema("W_IND_BASE", "W_IND_BASE", "Base industrial usada para normalizar.", "Industrial base used for normalization.", "percent", 3, "numeric"),
        "W_TOTAL": TableColumnUiSchema("W_TOTAL", "W_TOTAL", "Peso total combinado.", "Combined total weight.", "percent", 3, "numeric"),
        "TOTAL_kWh": TableColumnUiSchema("TOTAL_kWh", "TOTAL_kWh", "Demanda total resultante.", "Resulting total demand.", "kwh", 2, "numeric"),
    },
}
